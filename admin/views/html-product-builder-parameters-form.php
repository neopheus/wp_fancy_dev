			...
			<table class="form-table">
				<tbody>
					...
					<tr>
						...
						<td>
							<select multiple="multiple" name="designCategories[]" class="radykal-select2" style="width: 300px;">
							<?php
								...
								foreach($categories as $category) {
									...
									echo '<option value="'.$category->name.'">'.str_repeat("- ", $level).$category->name.'</option>';
								}
							?>
							</select>
						</td>
